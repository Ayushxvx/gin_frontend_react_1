      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-8 text-gray-100 font-sans">
        <div className="max-w-4xl mx-auto">
          ...
          <footer className="mt-16 text-center">
            <a
              href="https://www.linkedin.com/in/ayush-verma-a31050293" 
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold shadow-lg transition"
            >
